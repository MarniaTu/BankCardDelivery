...
public class CardDeliveryTest {
    ...
    public void shouldCheckApplicationSendingSuccess() {
        ...
        $("[data-test-id='notification'] .notification__content").shouldHave(exactText("Встреча успешно забронирована на " + meetingDate), Duration.ofSeconds(15)).shouldBe(visible);
